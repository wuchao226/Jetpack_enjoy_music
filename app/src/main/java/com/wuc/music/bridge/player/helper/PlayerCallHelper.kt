package com.wuc.music.bridge.player.helper
...
import com.wuc.music.bridge.player.notification.PlayerReceiver
            ...
            override fun onCallStateChanged(state: Int, incomingNumber: String) {
                if (state == TelephonyManager.CALL_STATE_IDLE) { // 呼叫状态空闲
                    ...
                    if (mPlayerCallHelperListener != null) {
                        if (mPlayerCallHelperListener.isPlaying && !mPlayerCallHelperListener.isPaused) {
