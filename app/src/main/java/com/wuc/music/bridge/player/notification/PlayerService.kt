package com.wuc.music.bridge.player.notification
...
import com.wuc.architecture.utils.ImageUtils
...
import com.wuc.music.bridge.player.helper.PlayerCallHelper
import com.wuc.music.bridge.player.helper.PlayerCallHelper.PlayerCallHelperListener
import com.wuc.music.ui.MainActivity
import java.io.File
...
class PlayerService : Service() {
    ...
    companion object {
        const val NOTIFY_PREVIOUS = "com.wuc.music.previous"
        const val NOTIFY_CLOSE = "com.wuc.music.close"
        const val NOTIFY_PAUSE = "com.wuc.music.pause"
        const val NOTIFY_PLAY = "com.wuc.music.play"
        const val NOTIFY_NEXT = "com.wuc.music.next"
